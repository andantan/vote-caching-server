...
// tslint:disable
import { CacheBallotEventResponse } from "./ballot_create_event_message";
import { CacheBallotEventRequest } from "./ballot_create_event_message";
import { ValidateBallotEventResponse } from "./ballot_create_event_message";
import { ValidateBallotEventRequest } from "./ballot_create_event_message";
...
/**
 * @grpc/grpc-js definition for the protobuf service ballot_create_event_message.NewBallotEventService.
 *
...
export const newBallotEventServiceDefinition: grpc.ServiceDefinition<INewBallotEventService> = {
    validateNewBallotEvent: {
        path: "/ballot_create_event_message.NewBallotEventService/ValidateNewBallotEvent",
    ...
    cacheNewBallotEvent: {
        path: "/ballot_create_event_message.NewBallotEventService/CacheNewBallotEvent",
