...
// tslint:disable
import { CacheProposalEventResponse } from "./proposal_event_message";
import { CacheProposalEventRequest } from "./proposal_event_message";
import { ValidateProposalEventResponse } from "./proposal_event_message";
import { ValidateProposalEventRequest } from "./proposal_event_message";
...
export const newProposalEventServiceDefinition: grpc.ServiceDefinition<INewProposalEventService> = {
    ...
    cacheNewProposalEvent: {
        path: "/proposal_event_message.NewProposalEventService/CacheNewProposalEvent",
