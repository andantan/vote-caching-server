...
exports.ExpiredPendingEventService = exports.ReportPendingEventResponse = exports.ExpiredPendingEvent = void 0;
...
class ExpiredPendingEvent$Type extends runtime_4.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* int64 count = 2; */
        if (message.count !== 0n)
            writer.tag(2, runtime_1.WireType.Varint).int64(message.count);
        /* map<string, uint32> options = 3; */
        for (let k of globalThis.Object.keys(message.options))
            writer.tag(3, runtime_1.WireType.LengthDelimited).fork().tag(1, runtime_1.WireType.LengthDelimited).string(k).tag(2, runtime_1.WireType.Varint).uint32(message.options[k]).join();
 ...
 */
exports.ExpiredPendingEvent = new ExpiredPendingEvent$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ReportPendingEventResponse$Type extends runtime_4.MessageType {
    constructor() {
 ...
 */
exports.ReportPendingEventResponse = new ReportPendingEventResponse$Type();
/**
 * @generated ServiceType for protobuf service pending_event_message.ExpiredPendingEventService
 */
exports.ExpiredPendingEventService = new runtime_rpc_1.ServiceType("pending_event_message.ExpiredPendingEventService", [
    { name: "ReportExpiredPendingEvent", options: {}, I: exports.ExpiredPendingEvent, O: exports.ReportPendingEventResponse }
]);
//# sourceMappingURL=pending_event_message.js.map